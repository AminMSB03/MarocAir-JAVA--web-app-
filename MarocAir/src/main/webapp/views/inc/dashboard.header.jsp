...
<div>
    <div class="fixed inset-0 flex z-40 md:hidden" role="dialog" aria-modal="true">
        ...
        <div x-show="open" x-transition x-data="{ open: true }" class="relative flex-1 flex flex-col max-w-xs w-full bg-indigo-700">
            ...
            <div x-show="open" x-transition class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
